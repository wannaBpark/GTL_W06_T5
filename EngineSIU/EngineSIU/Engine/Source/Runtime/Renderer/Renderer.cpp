...
void FRenderer::CreateConstantBuffers()
{
    ...
    UINT PointLightShadowBufferSize = sizeof(FPointLightShadowConstantBuffer);
    BufferManager->CreateBufferGeneric<FPointLightShadowConstantBuffer>("FPointLightShadowConstantBuffer", nullptr, PointLightShadowBufferSize, D3D11_BIND_CONSTANT_BUFFER, D3D11_USAGE_DYNAMIC, D3D11_CPU_ACCESS_WRITE);
